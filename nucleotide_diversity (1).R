...
Genome.AVOallSF6401 <- readData("allAVOmerge1_2GBS_SF6401_NoMiss_Bia_SNP_C_D1000bp_Bia.recode.vcf", format="VCF", gffpath=FALSE)
...
library("poppr")
library("pegas")
HW_GI_GbsAvoAllSF6401 <- hw.test(GI_GbsAvoAllSF6401, B = 1000) # performs 1000 permuatations
